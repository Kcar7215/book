...
Commands:
  create  Create a temporary Tempo session and persist it locally
  revoke  Revoke a Tempo session key on-chain when provisioned, then clear local
          key material
