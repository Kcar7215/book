...
Options:
      --constructor-args <ARGS>
          ...
          [alias: --encoded-constructor-args]
...
Verifier options:
      --license-type <LICENSE>
          ...
          [https://etherscan.io/contract-license-types](https://etherscan.io/contract-license-types)) or a common SPDX
          identifier such as `MIT`, `Apache-2.0`, `GPL-3.0-or-later`, or
          `AGPL-3.0-or-later`. Only used for Etherscan-style verifiers.
